...
ImageLoader img_carImage;
    ...
    public EditServiceAdapter(Context con, List<CommonBean> alBean, EditBookInterface interfac) {
        context = con;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Log.i("MM", "IF : ");
        rowView = inflater.inflate(R.layout.edit_book_contents, viewGroup, false);
        ...
        holder.txt_edit=(TextView) rowView.findViewById(R.id.txt_edit);
