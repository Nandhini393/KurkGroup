...
import com.aryvart.carservice.Adapters.ViewBookAdapter;
 ...
 */
public class ViewBookingList extends Activity implements EditBookInterface {
    ListView listEditService;
    ViewBookAdapter mAdapter;
    Context context;
    GeneralData gD;
    ImageView img_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_book_service);
        context = this;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                           ...
                           if (jsobj.getString("code").equalsIgnoreCase("2")) {
                               ...
                               JSONArray services_stations = jsobj1.getJSONArray("bookings");
                                ...
                                if (services_stations.length() > 0) {
                                    ...
                                    for (int i = 0; i < services_stations.length(); i++) {
                                        ...
                                        drawerBean.setStr_BookStatus(providersServiceJSONobject.getString("status"));
                                ...
                                mAdapter = new ViewBookAdapter(context, beanArrayList, (EditBookInterface) context);
                               ...
                               listEditService.setVisibility(View.GONE);
                               txt_error.setText("No bookings available");
...
//3Secs
        RequestQueue requestQueue = Volley.newRequestQueue(ViewBookingList.this);
